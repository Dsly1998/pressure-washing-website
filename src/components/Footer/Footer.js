  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <a href="tel:+13862752180" className="footer__icon-wrapper">
      ...
      <a
        href="mailto:Redlineandbluepressurewashing@gmail.com"
        className="footer__icon-wrapper"
      >
        <img src={mail} alt="Email" className="footer__icon" />
        <p className="footer__icon-label">
          Redlineandbluepressurewashing@gmail.com
        </p>
      </a>
      <div className="footer__bottom">
        <p className="footer__text">
          Copyright © 2025 · Red Line & Blue Pressure Washing
        </p>
      </div>
    </footer>
  );
